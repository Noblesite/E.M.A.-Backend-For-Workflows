...
class AssignIntAppToSmartGroupDTO(BaseModel):
    success: bool = False
    ...
    def from_api_response(cls, api_response: dict):
        ...
        raise ValueError("AssignIntAppToSmartGroupDTO Missing Values")
...
try:
    ...
    dto = AssignIntAppToSmartGroupDTO.from_api_response(api_response)
    print(dto.success)
