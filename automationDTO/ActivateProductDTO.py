...
class ActivateProductDTO(BaseModel):
    ...
    def from_api_response(cls, api_response: dict):
        ...
        raise ValueError("ActivateProductDTO Missing Values")
...
# Example usage
try:
    api_response = {"errorCode": "123", "message": "Sample error message"}
    dto = ActivateProductDTO.from_api_response(api_response)
    print(dto.success)
