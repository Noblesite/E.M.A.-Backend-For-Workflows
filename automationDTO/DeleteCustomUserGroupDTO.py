...
class DeleteCustomUserGroupDTO(BaseModel):
    success: bool = False
    ...
    def from_api_response(cls, api_response: dict):
        ...
        raise ValueError("DeleteCustomUserGroupDTO Missing Values")
...
try:
    api_response = {}
    dto = DeleteCustomUserGroupDTO.from_api_response(api_response)
    print(dto.success)
