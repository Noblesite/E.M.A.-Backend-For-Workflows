...
class AddCustomAttributeDTO(BaseModel):
    success: bool = False
    ...
    def from_api_response(cls, api_response: dict):
        ...
        raise ValueError("AddCustomAttributeDTO Missing Values")
...
# Example usage
try:
    api_response = {"errorCode": "456", "message": "Custom attribute error"}
    dto = AddCustomAttributeDTO.from_api_response(api_response)
    print(dto.success)
