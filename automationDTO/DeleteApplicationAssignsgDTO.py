...
class DeleteApplicationAssignsgDTO(BaseModel):
    success: bool = False
    ...
    def from_api_response(cls, api_response: dict):
        ...
        raise ValueError("DeleteApplicationAssignsgDTO Missing Values")
...
try:
    api_response = {}
    dto = DeleteApplicationAssignsgDTO.from_api_response(api_response)
    print(dto.success)
